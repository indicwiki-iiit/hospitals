...
BloodStorage_URL = 'https://www.nabh.co/frmViewAccreditedBloodStorageCentre.aspx' #1 entry
...
#Allopathic Clinics
AlloClinic_URL = 'https://www.nabh.co/frmViewAccreditedAllopathicClinics.aspx' #33 entries
...
Ethics_Comm_URL = 'https://www.nabh.co/frmViewAccreditedClinicalTrial.aspx' #170 entries
...
extra_additional_cols = ['Systems', 'Date_First', 'Medical_College', 'Established_Year', 'Services', 'Professions','Website', 'Lab_Services', 'Diagnostic_Services','Num_Staff', 'Num_Beds','Bloodbank','Ambulance','Pharmacy','Other_Facilities']


result = pd.concat(merge)
result = result.rename(columns={"Acc. No.":"Code","Valid From":"Valid_From","Valid Upto":"Valid_Upto"})
